...
local AmberHub = Instance.new("ScreenGui")
AmberHub.Name = "AmberHub"
if syn then
	syn.protect_gui(AmberHub)
	AmberHub.Parent = game.CoreGui
else
	AmberHub.Parent = gethui() or game.CoreGui
end

if gethui then
	for _, Interface in ipairs(gethui():GetChildren()) do
		if Interface.Name == AmberHub.Name and Interface ~= AmberHub then
			Interface:Destroy()
		end
	end
else
...
local function LoadCfg(Config)
	...
	table.foreach(Data, function(a,b)
		if library.Flags[a] then
			...
			warn("AmberHub Library Config Loader - Could not find ", a ,b)
		end
	end)
end
...
function library:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "AmberHub Library"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "AmberHub Library"
